...
SidecarEnvValues loadFrom(String? Function(String key) lookup) {
  return SidecarEnvValues(
    bind: _nonEmpty(lookup('EVGL_SIDECAR_BIND')) ?? '127.0.0.1:9090',
  );
}
...
Map<String, String> loadEnvMap(
  ...
  final out = <String, String>{};
  final bind = pick(['EVGL_SIDECAR_BIND'], ['flags', 'env_shell', 'env_file'], shell, dotenv, flags, '127.0.0.1:9090');
  if (bind != null) out['EVGL_SIDECAR_BIND'] = bind;
  return out;
}
